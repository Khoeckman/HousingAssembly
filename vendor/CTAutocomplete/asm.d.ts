...
declare global {
  interface IASM {
    ...
    removeBuilder(className: string, methodName: string, descriptor: string, at: InjectionPoint): RemoveBuilder

    fieldBuilder(className: string, fieldName: string, descriptor: string, ...accessTypes: AccessType[]): FieldBuilder
  }
}
...
declare class FieldBuilder {
  constructor(className: string, fieldName: string, descriptor: string, accessTypes?: AccessType)
...
declare class WrappedInsnListBuilder {
   ...
   */
  multianewarray(descriptor: string, dimensions: number): WrappedInsnListBuilder
  /**
   ...
   */
  synchronized(code: ($: WrappedInsnListBuilder) => void): WrappedInsnListBuilder
...
declare class SwitchBuilder {
  case(index: number, fallthrough?: boolean, builder?: ($: WrappedInsnListBuilder) => void): void

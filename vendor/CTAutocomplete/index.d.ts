...
declare global {
  ...
  function cancel(
    event: ForgePlaySoundEvent | CancellableEvent | ForgeEvent | (string | ForgeClientChatReceivedEvent)
  ): void
  // extend prototype
  interface String {
  ...
  class Renderer {
    ...
    drawRect(color: number, x: number, y: number, width: number, height: number): void
    ...
    drawLine(color: number, x1: number, y1: number, x2: number, y2: number, thickness: number, drawMode?: number): void
    static drawLine(
      color: number,
      x1: number,
      y1: number,
    ...
    drawCircle(color: number, x: number, y: number, radius: number, steps: number, drawMode?: number): void
    ...
    static drawImage(image: Image, x: number, y: number, width: number, height: number): void
  ...
  class Shape {
     ...
     */
    setLine(x1: number, y1: number, x2: number, y2: number, thickness: number): Shape
  ...
  class Tessellator {
     ...
     * @return the Tessellator to allow for method chaining
     */
    colorize(red: number, green: number, blue: number, alpha?: number): Tessellator
    /**
     * Colorize the Tessellator.
     *
     * @param red the red value between 0 and 1
     ...
     * @return the Tessellator to allow for method chaining
     */
    static colorize(red: number, green: number, blue: number, alpha?: number): Tessellator
  ...
  class NBTTagList extends NBTBase {
    ...
    get(index: number, type: NBTTagCompound['NBTDataType']): number | string | number[] | MCNBTTagCompound | NBTBase
  ...
  class ReflectionHelper {
    ...
    static getPrivateValue<T, E>(classToAccess: JavaClass<T>, instance: T, fieldIndex: number): E

    static setPrivateValue<T, E>(classToAccess: JavaClass<T>, instance: T, value: E, fieldIndex: number): void
  ...
  class ChatLib {
     ...
     */
    getChatMessage(event: ForgeClientChatReceivedEvent, formatted?: boolean): string
    /**
     * Get the text of a chat event.
     * Defaults to the unformatted version.
     *
  ...
  class DisplayLine {
    ...
    registerClicked(method: (mouseX: number, mouseY: number, button: number, pressed: boolean) => void): RegularTrigger

    registerHovered(method: (mouseX: number, mouseY: number) => void): RegularTrigger

    registerMouseLeave(method: (mouseX: number, mouseY: number) => void): RegularTrigger

    registerDragged(
      method: (xDist: number, yDist: number, mouseX: number, mouseY: number, button: number) => void
    ): RegularTrigger
  ...
  class Display {
     ...
     */
    setRegisterType(
      registerType: 'RENDER_OVERLAY_EVENT' | 'POST_GUI_RENDER_EVENT' | DisplayHandler.RegisterType | any
    ): Display
  ...
  class EventLib {
     ...
     * @throws IllegalArgumentException if event can be cancelled "normally"
     */
    static cancel(event: ForgePlaySoundEvent | CancellableEvent | ForgeEvent): void
  }
  ...
  class FileLib {
     ...
     * @param recursive whether to create folders to the file location if they don't exist
     */
    static write(importName: string, fileName: string, toWrite: string, recursive?: boolean): void
     ...
     * @param recursive whether to create folders to the file location if they don't exist
     */
    static write(fileLocation: string, toWrite: string, recursive?: boolean): void
  ...
  class Gui extends MCGuiScreen {
     ...
     */
    registerScrolled(method: (mouseX: number, mouseY: number, scroll: number) => void): RegularTrigger
     ...
     * @return the trigger
     */
    registerKeyTyped(method: (typed: string, key: number) => void): RegularTrigger
    ...
    registerMouseDragged(
      method: (mouseX: number, mouseY: number, clickedMouseButton: number, timeSinceLastClick: number) => void
    ): RegularTrigger
     ...
     * @return the trigger
     */
    registerActionPerformed(method: (button: MCGuiButton) => void): RegularTrigger
     ...
     * Internal method to run trigger. Not meant for public use
     */
    mouseClickMove(mouseX: number, mouseY: number, clickedMouseButton: number, timeSinceLastClick: number): void
     ...
     * @return the Gui for method chaining
     */
    addButton(buttonId: number, x: number, y: number, width: number, height: number, buttonText: string): Gui
...
declare interface JavaTypePath {
  // obfuscated paths
  (path: 'net.minecraft.client.gui.inventory.GuiContainer'): typeof MCGuiContainer
  (path: 'net.minecraft.inventory.Slot'): typeof MCSlot
  (path: 'net.minecraft.util.Vec3'): typeof MCVec3
  (path: 'net.minecraft.client.renderer.GlStateManager'): typeof MCGlStateManager
  ...
  // forge paths
  (path: 'net.minecraftforge.fml.common.network.FMLNetworkEvent'): FMLNetworkEventStatic
...
type NBTType = string | number | number[] | { [key: string]: NBTType } | NBTType[]
...
declare abstract class FMLNetworkEvent$CustomPacketEvent extends ForgeEvent {
  ...
  new<T>(thing: T, type: JavaClass<T>, manager: any, packet: any): FMLNetworkEvent$CustomPacketEvent
...
declare namespace ForgeGuiScreenEvent {
  ...
  class DrawScreenEvent extends ForgeGuiScreenEvent {
    ...
    constructor(gui: MCGuiScreen, mouseX: number, mouseY: number, renderPartialTicks: number)
  }
}
...
declare class JavaURL {
   ...
   */
  constructor(protocol: string, host: string, port: number, file: string, handler: JavaURLStreamHandler)
...
declare class CommandTrigger extends Trigger {
   ...
   * @return the trigger for additional modification
   */
  setCommandName(commandName: string, overrideExisting?: boolean): CommandTrigger
...
declare class Client {
   ...
   * @param fadeOut time to fade out
   */
  static showTitle(title: string, subtitle: string, fadeIn: number, time: number, fadeOut: number): void
}
...
declare class Console {
  ...
  println(obj: any, logType?: LogType, end?: string, customColor?: JavaColor): void
}
...
declare interface ITriggerRegister {
   ...
   * @return The trigger for additional modification
   */
  registerActionBar(method: (...params: (string | ForgeClientChatReceivedEvent)[]) => void): ChatTrigger
   ...
   * @return The trigger for additional modification
   */
  registerAttackEntity(method: (entity: Entity, event: CancellableEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerChat(method: (...args: (string | ForgeClientChatReceivedEvent)[]) => void): ChatTrigger
   ...
   * @return The trigger for additional modification
   */
  registerChatComponentClicked(method: (component: TextComponent, event: CancellableEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerChatComponentHovered(method: (component: TextComponent, event: CancellableEvent) => void): EventTrigger
   ...
   */
  registerClicked(
    method: (mouseX: number, mouseY: number, button: number, isButtonDown: boolean) => void
  ): RegularTrigger
   ...
   */
  registerDragged(
    method: (mouseDeltaX: number, mouseDeltaY: number, mouseX: number, mouseY: number, button: number) => void
  ): RegularTrigger
   ...
   * @return The trigger for additional modification
   */
  registerDropItem(method: (item: Item, player: PlayerMP, event: CancellableEvent) => void): EventTrigger
   ...
   *
   */
  registerGuiDrawBackground(method: (gui: MCGuiScreen, event: CancellableEvent) => void): EventTrigger
   ...
   */
  registerGuiKey(
    method: (char: string, keyCode: number, gui: MCGuiScreen, event: CancellableEvent) => void
  ): EventTrigger
  ...
  registerGuiMouseClick(
    method: (mouseX: number, mouseY: number, mouseButton: number, gui: MCGuiScreen, event: CancellableEvent) => void
  ): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerGuiRender(method: (mouseX: number, mouseY: number, gui: MCGuiScreen) => void): RegularTrigger
   ...
   * @return The trigger for additional modification
   */
  registerHitBlock(method: (block: Block, event: CancellableEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerMessageSent(method: (message: string, event: CancellableEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerPacketReceived(method: (packet: MCPacket<MCINetHandler>, event: CancellableEvent) => void): PacketTrigger
   ...
   * @return The trigger for additional modification
   */
  registerPacketSent(method: (packet: MCPacket<MCINetHandler>, event: CancellableEvent) => void): PacketTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderSlot(method: (slot: Slot, gui: MCGuiContainer, event: CancellableEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerScreenshotTaken(method: (name: string, event: CancellableEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerScrolled(method: (mouseX: number, mouseY: number, direction: number) => void): RegularTrigger
   ...
   * @return The trigger for additional modification
   */
  registerServerConnect(method: (event: FMLNetworkEvent$ClientConnectedToServerEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerServerDisconnect(method: (event: FMLNetworkEvent$ClientDisconnectionFromServerEvent) => void): RegularTrigger
   ...
   * @return The trigger for additional modification
   */
  registerItemTooltip(method: (lore: string[], item: Item, event: CancellableEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerDrawBlockHighlight(method: (position: Vector3f, event: ForgeDrawBlockHighlightEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerPostGuiRender(method: (mouseX: number, mouseY: number, gui: MCGuiScreen) => void): RegularTrigger
   ...
   * @return The trigger for additional modification
   */
  registerPostRenderEntity(method: (entity: Entity, pos: Vector3f, partialTicks: number) => void): RenderEntityTrigger
  ...
  registerPreItemRender(
    method: (mouseX: number, mouseY: number, slot: MCSlot, gui: MCGuiContainer) => void
  ): RegularTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderAir(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderArmor(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderBossHealth(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderChat(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderCrosshair(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderDebug(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
  ...
  registerRenderEntity(
    method: (entity: MCEntity, position: Vector3f, partialTicks: number, event: CancellableEvent) => void
  ): RenderEntityTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderExperience(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderFood(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderHealth(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderHelmet(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderHotbar(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderItemIntoGui(method: (item: Item, x: number, y: number, event: CancellableEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderJumpBar(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderMountHealth(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderOverlay(method: (event: ForgeRenderGameOverlayEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderPlayerList(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderPortal(method: (event: ForgeRenderGameOverlayEvent & CancellableEventHelper) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderScoreboard(method: (event: CancellableEvent) => void): EventTrigger
  ...
  registerRenderSlotHighlight(
    method: (mouseX: number, mouseY: number, slot: MCSlot, gui: MCGuiContainer, event: CancellableEvent) => void
  ): EventTrigger
  ...
  registerRenderTileEntity(
    method: (entity: MCTileEntity, pos: Vector3f, partialTicks: number, event: CancellableEvent) => void
  ): RenderTileEntityTrigger
   ...
   * @return The trigger for additional modification
   */
  registerRenderTitle(method: (title: string, subtitle: string, event: CancellableEvent) => void): EventTrigger
   ...
   * @return The trigger for additional modification
   */
  registerEntityDamage(method: (target: Entity, attacker: PlayerMP) => void): RegularTrigger
...
declare interface IRegister {
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'actionBar', method: Parameters<ITriggerRegister['registerActionBar']>[0]): ReturnType<
    ITriggerRegister['registerActionBar']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'attackEntity', method: Parameters<ITriggerRegister['registerAttackEntity']>[0]): ReturnType<
    ITriggerRegister['registerAttackEntity']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'chat', method: Parameters<ITriggerRegister['registerChat']>[0]): ReturnType<
    ITriggerRegister['registerChat']
  >
  /**
   * Registers a new trigger that runs whenever the user clicks on a clickable
   * chat component
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'clicked', method: Parameters<ITriggerRegister['registerClicked']>[0]): ReturnType<
    ITriggerRegister['registerClicked']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'dragged', method: Parameters<ITriggerRegister['registerDragged']>[0]): ReturnType<
    ITriggerRegister['registerDragged']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'dropItem', method: Parameters<ITriggerRegister['registerDropItem']>[0]): ReturnType<
    ITriggerRegister['registerDropItem']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'gameLoad', method: Parameters<ITriggerRegister['registerGameLoad']>[0]): ReturnType<
    ITriggerRegister['registerGameLoad']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'gameUnload', method: Parameters<ITriggerRegister['registerGameUnload']>[0]): ReturnType<
    ITriggerRegister['registerGameUnload']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'guiClosed', method: Parameters<ITriggerRegister['registerGuiClosed']>[0]): ReturnType<
    ITriggerRegister['registerGuiClosed']
  >
   ...
   *
   */
  (triggerType: 'guiDrawBackground', method: Parameters<ITriggerRegister['registerGuiDrawBackground']>[0]): ReturnType<
    ITriggerRegister['registerGuiDrawBackground']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'guiKey', method: Parameters<ITriggerRegister['registerGuiKey']>[0]): ReturnType<
    ITriggerRegister['registerGuiKey']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'guiMouseClick', method: Parameters<ITriggerRegister['registerGuiMouseClick']>[0]): ReturnType<
    ITriggerRegister['registerGuiMouseClick']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'guiMouseDrag', method: Parameters<ITriggerRegister['registerGuiMouseDrag']>[0]): ReturnType<
    ITriggerRegister['registerGuiMouseDrag']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'guiMouseRelease', method: Parameters<ITriggerRegister['registerGuiMouseRelease']>[0]): ReturnType<
    ITriggerRegister['registerGuiMouseRelease']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'guiOpened', method: Parameters<ITriggerRegister['registerGuiOpened']>[0]): ReturnType<
    ITriggerRegister['registerGuiOpened']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'guiRender', method: Parameters<ITriggerRegister['registerGuiRender']>[0]): ReturnType<
    ITriggerRegister['registerGuiRender']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'hitBlock', method: Parameters<ITriggerRegister['registerHitBlock']>[0]): ReturnType<
    ITriggerRegister['registerHitBlock']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'messageSent', method: Parameters<ITriggerRegister['registerMessageSent']>[0]): ReturnType<
    ITriggerRegister['registerMessageSent']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'packetReceived', method: Parameters<ITriggerRegister['registerPacketReceived']>[0]): ReturnType<
    ITriggerRegister['registerPacketReceived']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'packetSent', method: Parameters<ITriggerRegister['registerPacketSent']>[0]): ReturnType<
    ITriggerRegister['registerPacketSent']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'pickupItem', method: Parameters<ITriggerRegister['registerPickupItem']>[0]): ReturnType<
    ITriggerRegister['registerPickupItem']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'playerInteract', method: Parameters<ITriggerRegister['registerPlayerInteract']>[0]): ReturnType<
    ITriggerRegister['registerPlayerInteract']
  >
  /**
   * Registers a new trigger that runs before a slot is drawn in a container
   * This is useful for hiding "background" items in containers used as GUIs.
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderSlot', method: Parameters<ITriggerRegister['registerRenderSlot']>[0]): ReturnType<
    ITriggerRegister['registerRenderSlot']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'screenshotTaken', method: Parameters<ITriggerRegister['registerScreenshotTaken']>[0]): ReturnType<
    ITriggerRegister['registerScreenshotTaken']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'scrolled', method: Parameters<ITriggerRegister['registerScrolled']>[0]): ReturnType<
    ITriggerRegister['registerScrolled']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'serverConnect', method: Parameters<ITriggerRegister['registerServerConnect']>[0]): ReturnType<
    ITriggerRegister['registerServerConnect']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'serverDisconnect', method: Parameters<ITriggerRegister['registerServerDisconnect']>[0]): ReturnType<
    ITriggerRegister['registerServerDisconnect']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'step', method: Parameters<ITriggerRegister['registerStep']>[0]): ReturnType<
    ITriggerRegister['registerStep']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'tick', method: Parameters<ITriggerRegister['registerTick']>[0]): ReturnType<
    ITriggerRegister['registerTick']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'itemTooltip', method: Parameters<ITriggerRegister['registerItemTooltip']>[0]): ReturnType<
    ITriggerRegister['registerItemTooltip']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'postGuiRender', method: Parameters<ITriggerRegister['registerPostGuiRender']>[0]): ReturnType<
    ITriggerRegister['registerPostGuiRender']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'postRenderEntity', method: Parameters<ITriggerRegister['registerPostRenderEntity']>[0]): ReturnType<
    ITriggerRegister['registerPostRenderEntity']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'preItemRender', method: Parameters<ITriggerRegister['registerPreItemRender']>[0]): ReturnType<
    ITriggerRegister['registerPreItemRender']
  >
  /**
   * Registers a new trigger that runs before the player's air level is drawn.
   *
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderAir', method: Parameters<ITriggerRegister['registerRenderAir']>[0]): ReturnType<
    ITriggerRegister['registerRenderAir']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderArmor', method: Parameters<ITriggerRegister['registerRenderArmor']>[0]): ReturnType<
    ITriggerRegister['registerRenderArmor']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderBossHealth', method: Parameters<ITriggerRegister['registerRenderBossHealth']>[0]): ReturnType<
    ITriggerRegister['registerRenderBossHealth']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderChat', method: Parameters<ITriggerRegister['registerRenderChat']>[0]): ReturnType<
    ITriggerRegister['registerRenderChat']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderCrosshair', method: Parameters<ITriggerRegister['registerRenderCrosshair']>[0]): ReturnType<
    ITriggerRegister['registerRenderCrosshair']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderDebug', method: Parameters<ITriggerRegister['registerRenderDebug']>[0]): ReturnType<
    ITriggerRegister['registerRenderDebug']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderEntity', method: Parameters<ITriggerRegister['registerRenderEntity']>[0]): ReturnType<
    ITriggerRegister['registerRenderEntity']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderExperience', method: Parameters<ITriggerRegister['registerRenderExperience']>[0]): ReturnType<
    ITriggerRegister['registerRenderExperience']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderFood', method: Parameters<ITriggerRegister['registerRenderFood']>[0]): ReturnType<
    ITriggerRegister['registerRenderFood']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderHand', method: Parameters<ITriggerRegister['registerRenderHand']>[0]): ReturnType<
    ITriggerRegister['registerRenderHand']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderHealth', method: Parameters<ITriggerRegister['registerRenderHealth']>[0]): ReturnType<
    ITriggerRegister['registerRenderHealth']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderHelmet', method: Parameters<ITriggerRegister['registerRenderHelmet']>[0]): ReturnType<
    ITriggerRegister['registerRenderHelmet']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderHotbar', method: Parameters<ITriggerRegister['registerRenderHotbar']>[0]): ReturnType<
    ITriggerRegister['registerRenderHotbar']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderItemIntoGui', method: Parameters<ITriggerRegister['registerRenderItemIntoGui']>[0]): ReturnType<
    ITriggerRegister['registerRenderItemIntoGui']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderJumpBar', method: Parameters<ITriggerRegister['registerRenderJumpBar']>[0]): ReturnType<
    ITriggerRegister['registerRenderJumpBar']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderMountHealth', method: Parameters<ITriggerRegister['registerRenderMountHealth']>[0]): ReturnType<
    ITriggerRegister['registerRenderMountHealth']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderOverlay', method: Parameters<ITriggerRegister['registerRenderOverlay']>[0]): ReturnType<
    ITriggerRegister['registerRenderOverlay']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderPlayerList', method: Parameters<ITriggerRegister['registerRenderPlayerList']>[0]): ReturnType<
    ITriggerRegister['registerRenderPlayerList']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderPortal', method: Parameters<ITriggerRegister['registerRenderPortal']>[0]): ReturnType<
    ITriggerRegister['registerRenderPortal']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderScoreboard', method: Parameters<ITriggerRegister['registerRenderScoreboard']>[0]): ReturnType<
    ITriggerRegister['registerRenderScoreboard']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderTileEntity', method: Parameters<ITriggerRegister['registerRenderTileEntity']>[0]): ReturnType<
    ITriggerRegister['registerRenderTileEntity']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderTitle', method: Parameters<ITriggerRegister['registerRenderTitle']>[0]): ReturnType<
    ITriggerRegister['registerRenderTitle']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'renderWorld', method: Parameters<ITriggerRegister['registerRenderWorld']>[0]): ReturnType<
    ITriggerRegister['registerRenderWorld']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'blockBreak', method: Parameters<ITriggerRegister['registerBlockBreak']>[0]): ReturnType<
    ITriggerRegister['registerBlockBreak']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'entityDamage', method: Parameters<ITriggerRegister['registerEntityDamage']>[0]): ReturnType<
    ITriggerRegister['registerEntityDamage']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'entityDeath', method: Parameters<ITriggerRegister['registerEntityDeath']>[0]): ReturnType<
    ITriggerRegister['registerEntityDeath']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'noteBlockChange', method: Parameters<ITriggerRegister['registerNoteBlockChange']>[0]): ReturnType<
    ITriggerRegister['registerNoteBlockChange']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'noteBlockPlay', method: Parameters<ITriggerRegister['registerNoteBlockPlay']>[0]): ReturnType<
    ITriggerRegister['registerNoteBlockPlay']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'playerJoined', method: Parameters<ITriggerRegister['registerPlayerJoined']>[0]): ReturnType<
    ITriggerRegister['registerPlayerJoined']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'playerLeft', method: Parameters<ITriggerRegister['registerPlayerLeft']>[0]): ReturnType<
    ITriggerRegister['registerPlayerLeft']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'soundPlay', method: Parameters<ITriggerRegister['registerSoundPlay']>[0]): ReturnType<
    ITriggerRegister['registerSoundPlay']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'spawnParticle', method: Parameters<ITriggerRegister['registerSpawnParticle']>[0]): ReturnType<
    ITriggerRegister['registerSpawnParticle']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'worldLoad', method: Parameters<ITriggerRegister['registerWorldLoad']>[0]): ReturnType<
    ITriggerRegister['registerWorldLoad']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'worldUnload', method: Parameters<ITriggerRegister['registerWorldUnload']>[0]): ReturnType<
    ITriggerRegister['registerWorldUnload']
  >
   ...
   * @return The trigger for additional modification
   */
  (triggerType: 'command', method: Parameters<ITriggerRegister['registerCommand']>[0]): ReturnType<
    ITriggerRegister['registerCommand']
  >
